...
1. **히어로 — 화면 폭 대형 포스터, 1:1 상단 기준 크롭(2026-09-10, 4:5에서 조정), 하단은 배경색으로 페이드**
...
```
히어로  height = width * 1              (1:1 — 2026-09-10 실기기 확인 후 4:5에서 조정)
...
- **처음엔 4:5를 택했으나 실기기에서 기본 정보 박스가 첫 화면에 다 안 들어와 1:1로 한 번 더
  줄였다(2026-09-10).** 2:3 full-bleed는 390px 폭 기기에서 **585px(화면의 69%)**,
  4:5는 487px(58%)로도 부족했다 — 아래 표 참고.

  | 비율 | 390px 기기 | 화면 점유 |
  |---|---|---|
  | 2:3 | 585px | 69% — 정보가 전부 밖 |
  | ~~4:5~~ | ~~487px~~ | ~~58% — 제목 + 카드 첫 줄이 들어온다~~ **실기기 확인 결과 부족(2026-09-10)** |
  | **1:1 (채택)** | **390px** | **46%** — "포스터 느낌이 옅어진다"는 우려보다 **첫 화면에 정보 박스가 들어오는 것**을 실기기 결과에 따라 우선했다 |
