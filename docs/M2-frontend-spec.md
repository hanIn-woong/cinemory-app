...
- **4:5를 택한 이유는 첫 화면에 정보가 들어와야 하기 때문**이다 — 2:3 full-bleed는 390px 폭
  기기에서 **585px(화면의 69%)** 가 되어 장르·감독·출연이 전부 스크롤 밖으로 밀린다.

  | 비율 | 390px 기기 | 화면 점유 |
  |---|---|---|
  | 2:3 | 585px | 69% — 정보가 전부 밖 |
  | **4:5** | **487px** | **58% — 제목 + 카드 첫 줄이 들어온다** |
  | 1:1 | 390px | 46% — 포스터 느낌이 옅어진다 |
