...
| **M2-C**<br>2군 화면 (10월) | `Wishlist` · `CollectionList`/`Detail` · `MovieDetail` 컬렉션 연결 | ⬜ **다음** | ✅ **API 완비 — 막는 것 없음**<br>B-6·B-7·B-18은 품질 개선(차단 아님) | **`M2C-screens-spec.md`**<br>요구사항은 §9.6~9.7 |
...
- **백엔드 선행 항목 18건** → **§11** (B-1~B-18. 미해소는 B-1·B-4·B-6~B-14·B-18)
